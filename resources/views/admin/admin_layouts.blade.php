...
<html lang="en">
  ...
  <body>
    ...
    @else
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i>ANJEL ECOMMERCE</a></div>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name">Anjel<span class="hidden-md-down"> ING</span></span>
              <img src="{{asset('public/backend/img/anjel.jpg')}}" class="wd-32 rounded-circle" alt="">
            </a>
